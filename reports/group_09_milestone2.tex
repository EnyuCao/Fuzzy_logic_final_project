...
The first implementation in the paper comes close to what we are implementing. We are using similar input, although (for the time being) we use one FLS with an incomplete rulebase to guide the robot.
